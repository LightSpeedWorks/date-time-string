...
// class Date : method toHttpDateTimeString extension
// Date+Time 日付+時刻
function toHttpDateTimeString(x) {
  x = x instanceof Date ? x : this instanceof Date ? this : new Date;
...
function extendDateToDateTimeString() {
  ...
  Date.prototype.toHttpDateTimeString = toHttpDateTimeString;
}
...
var DateTime = {
  ...
  toHttpDateTimeString:       toHttpDateTimeString,
